        ...
        return (
            <div>
                <div class="form-checkbox">
                    <label>
                        <input class="mt-2" aria-describedby="public-description" type="radio" value="public" checked="checked" name="repository[visibility]" id="repository_visibility_public" />
                        Public
                    </label>
                    <svg height="32" class="octicon octicon-repo float-left mt-1 mr-2" viewBox="0 0 24 24" version="1.1" width="32" aria-hidden="true">
                ...
                <div class="form-checkbox">
                    ...
                    <svg height="32" class="octicon octicon-lock color-private-icon float-left mt-1 mr-2" viewBox="0 0 24 24" version="1.1" width="32" aria-hidden="true">
